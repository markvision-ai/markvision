-- Final update for ground-truth accuracy
-- Reverting to pull from clients_config.meta_spend and meta_leads
-- which the Edge Function now updates using date_preset=this_month.
...
LEFT JOIN 
    cma ON cc.ad_account_id = cma.ad_account_id
LEFT JOIN 
