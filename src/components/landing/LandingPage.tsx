      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-32 pb-20 bg-gradient-to-b from-slate-50 via-white to-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          duration: 0.6
            ...
            <p className="text-lg sm:text-xl text-slate-500 leading-relaxed">MarkVision AI — первая автономная система управления прибылью 
для медицинских клиник.<span className="font-semibold text-slate-700">MarkVision AI</span> — первая автономная система 
              <br className="hidden sm:block" />
              управления прибылью для клиник.
            </p>
            <p className="text-xl sm:text-2xl font-semibold text-slate-800">
              Увеличьте выручку на <span className="text-blue-600">
+500 000 ₸ в день</span>
            </p>
