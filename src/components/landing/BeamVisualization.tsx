...
const Circle = forwardRef<HTMLDivElement, {
  ...
  return <div className="flex flex-col items-center gap-2 sm:gap-3">
    <div ref={ref} className={cn("z-10 flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-2xl sm:rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-blue-900/5 shadow-blue-500/10 transition-all duration-300 hover:scale-110 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-blue-500/20", className)}>
      {children}
    </div>
