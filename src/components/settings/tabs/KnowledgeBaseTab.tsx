...
const categories = [
  ...
  { id: 'faq', label: 'База ответов (FAQ)', icon: BookOpen, color: 'text-emerald-500' },
];
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="h-12 bg-primary hover:bg-primary/90 text-white rounded-xl shadow-lg shadow-primary/20 px-8 gap-2 font-bold tracking-tight"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="flex items-start justify-between mb-4 relative z-10">
                      ...
                      <div className="flex items-center gap-2">
                        {doc.is_ai_trained && (
                          <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                            <span className="text-[10px] text-emerald-500 font-bold uppercase">AI Trained</span>
                          </div>
                        )}
                      ...
                      <div className="flex items-center gap-1">
                        {!doc.is_ai_trained && (
                          <Button
                            ...
                            className="w-8 h-8 rounded-lg hover:bg-emerald-500/10 hover:text-emerald-500 transition-colors"
                            title="Обучить ИИ"
                          >
        ...
        <DialogContent className="max-w-2xl bg-black/60 backdrop-blur-3xl border-white/5 p-0 overflow-hidden rounded-3xl">
          ...
          <DialogFooter className="p-8 pt-4 bg-white/5 border-t border-white/5 gap-3 relative z-10">
            ...
            <Button
              ...
              className="h-12 px-10 rounded-xl bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 font-bold gap-2"
            >
