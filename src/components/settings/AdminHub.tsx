...
export const AdminHub = ({ projectId, projects }: AdminHubProps) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      {/* Premium Header */}
      <div className="interstellar-glass border border-white/5 p-8 rounded-3xl relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-3">
            <Badge variant="outline" className="bg-white/5 border-white/10 px-3 py-1 text-xs font-medium text-white/60">
          ...
          >
            ...
            <TabsContent value="general" className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-0">
              <div className="lg:col-span-2 space-y-8">
                <div className="interstellar-glass border border-white/5 p-8 rounded-3xl space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="clinicName" className="text-white/60 text-sm">Название клиники / Проекта</Label>
                    ...
                    {/* Currency */}
                    <div className="space-y-3">
                      <Label htmlFor="currency" className="text-white/60 text-sm">Валюта проекта</Label>
                      <div className="flex items-center gap-3">
                        <select
                          id="currency"
                          value={projectSettings.currency}
                          onChange={(e) => setProjectSettings(prev => ({ ...prev, currency: e.target.value }))}
                          className="flex h-12 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-white focus:ring-2 focus:ring-primary/50 outline-none appearance-none"
                        >
                  ...
                  <div className="space-y-4 pt-4">
                    <Label className="text-white/60 text-sm">Логотип бренда</Label>
                    <div className="flex flex-col md:flex-row items-center gap-8 p-6 rounded-2xl bg-white/5 border border-dashed border-white/10">
                      <div className="relative group">
                        <div className="w-24 h-24 rounded-2xl bg-black/50 border border-white/10 flex items-center justify-center overflow-hidden shadow-2xl">
                      ...
                      <div className="flex-1 space-y-4 text-center md:text-left">
                        ...
                        <Button
                          ...
                          variant="secondary"
                          disabled={uploading}
                          className="bg-white/10 hover:bg-white/20 border-white/10 h-10 px-6 rounded-xl transition-all"
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="interstellar-glass border border-white/5 p-6 rounded-3xl flex items-center gap-4">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="interstellar-glass border border-white/5 p-8 rounded-3xl bg-primary/5 relative overflow-hidden group">
                ...
                <div className="interstellar-glass border border-white/5 p-6 rounded-3xl text-center space-y-4">
                  <AlertCircle className="w-10 h-10 mx-auto text-white/10" />
                  <div>
                    <p className="text-sm text-white/40">Скоро здесь появится</p>
            ...
            <TabsContent value="team" className="mt-0">
              <div className="interstellar-glass border border-white/5 p-8 rounded-3xl min-h-[600px]">
