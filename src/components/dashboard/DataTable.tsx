...
export const DataTable = ({ dailyData, onDataChange }: DataTableProps) => {
  ...
  const exportToCSV = () => {
    const headers = ['Дата', 'День', 'Расходы', 'Показы', 'Лиды', 'Диагностики', 'Продажи', 'Выручка'];
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {daysInMonth.map((day) => {
              ...
              return (
                ...
                >
                  ...
                  {(['spend', 'impressions', 'leads', 'diagnostics', 'sales', 'revenue'] as const).map((field) => (
            ...
            <tr className="bg-secondary font-semibold">
              <td className="p-4 sticky left-0 bg-secondary">Итого за месяц</td>
