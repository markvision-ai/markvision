...
export const BulkActionsBar = ({
  ...
  return (
    <motion.div
      ...
      className="crm-card-glass rounded-2xl p-4 border border-primary/20 shadow-lg"
    >
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 crm-card-glass">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent className="crm-card-glass">
              <AlertDialogHeader>
