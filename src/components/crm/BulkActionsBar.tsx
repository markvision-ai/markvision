...
export const BulkActionsBar = ({
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl p-4 bg-white/10 backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 border border-white/50 shadow-md"
    >
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent className="bg-white/10 backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 border border-white/50">
              <AlertDialogHeader>
