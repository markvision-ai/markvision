...
export const LeadFullPage = ({ lead, projectId, onClose, onUpdate }: LeadFullPageProps) => {
  ...
  return createPortal(
    <AnimatePresence>
      <motion.div
        className="fixed inset-0 z-[100] bg-white/5 flex flex-col"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      >
              ...
              <div className="p-6 md:p-8 max-w-[1200px] mx-auto pb-40 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <motion.div
                    ...
                    className="md:col-span-2 bg-white/10 backdrop-blur-3xl border border-white/60 shadow-xl p-8 rounded-[2.5rem] border-white/5 relative overflow-hidden group"
                  >
                  ...
                  <motion.div
                    ...
                    className="bg-white/10 backdrop-blur-3xl border border-white/60 shadow-xl p-8 rounded-[2.5rem] border-white/5"
                  >
                    <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent className="bg-white/10 backdrop-blur-3xl border border-white/60 shadow-xl border-slate-200">
                      ...
                      <div className="grid grid-cols-1 gap-3 pt-2">
                        <Button
                          ...
                          className={cn(
                            ...
                            isVisitDone
                              ? 'bg-white/10 backdrop-blur-3xl border border-white/60 shadow-xl bg-violet-600/20 text-violet-400 hover:bg-violet-600/30'
