...
export function AddLeadDialog({ projectId, onLeadAdded, onDuplicateFound }: AddLeadDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md bg-white/5 border border-white/50 shadow-2xl">
        <DialogHeader>
        ...
        >
          ...
          >
            ...
            <Input
              ...
              className="h-12 rounded-xl bg-muted/50 border-white/50 text-foreground placeholder:text-muted-foreground focus:border-primary/50 focus:bg-white/5 focus:ring-2 focus:ring-primary/20 transition-all"
            />
          </motion.div>
          ...
          >
            ...
            <div className="space-y-1">
              <Input
                ...
                className={cn(
                  "h-12 rounded-xl bg-muted/50 border-white/50 text-foreground placeholder:text-muted-foreground focus:border-primary/50 focus:bg-white/5 focus:ring-2 focus:ring-primary/20 transition-all",
