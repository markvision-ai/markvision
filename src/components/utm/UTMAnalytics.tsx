...
const statusColors: Record<string, string> = {
  'new': 'bg-blue-900/50 text-blue-200 border-blue-800',
  'processing': 'bg-yellow-900/50 text-yellow-200 border-yellow-800',
  'qualified': 'bg-green-900/50 text-green-200 border-green-800',
