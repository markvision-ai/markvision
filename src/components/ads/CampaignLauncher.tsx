...
export const CampaignLauncher = ({ projectId, isOpen, onClose }: CampaignLauncherProps) => {
    ...
    return (
        <Sheet open={isOpen} onOpenChange={onClose}>
            <SheetContent
                className="w-full sm:max-w-xl p-0 border-l border-white/50 bg-white/10 backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 overflow-hidden flex flex-col"
            >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Select value={objective} onValueChange={setObjective}>
                                        ...
                                        <SelectContent className="bg-white/10 backdrop-blur-2xl border border-white/60 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                                ...
                                <AnimatePresence mode="wait">
                                    {!file ? (
                                        <motion.div
                                            ...
                                            className="group relative overflow-hidden border-2 border-dashed border-slate-200 hover:border-primary/50 hover:bg-primary/5 cursor-pointer rounded-[2rem] p-12 transition-all flex flex-col items-center justify-center gap-4 bg-white/[0.01] shadow-inner"
                                        >
