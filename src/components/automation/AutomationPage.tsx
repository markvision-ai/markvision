  ...
  const handleRefresh = useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (import.meta.env.DEV) console.error('[Обновить] Ошибка sync n8n:', res.status, errorText);
      ...
      if (import.meta.env.DEV) console.error('[Обновить] Ошибка синхронизации:', msg);
