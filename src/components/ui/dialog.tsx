...
>(({ className, children, hideCloseButton = false, ...props }, ref) => {
  ...
  // Check if children contains a DialogTitle for accessibility
  const hasDialogTitle = React.Children.toArray(children).some(
    (child) => React.isValidElement(child) && 
    (child.type === DialogTitle || 
     (child.type as any)?.displayName === 'DialogTitle' ||
     // Check for DialogHeader which typically contains DialogTitle
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        aria-describedby={hasDialogDescription ? undefined : descriptionId}
        className={cn(
        ...
        {...props}
      >
        {/* Hidden title for accessibility if no visible title exists */}
        {!hasDialogTitle && (
