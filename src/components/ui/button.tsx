  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-white/5 hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-white/10 text-foreground border border-primary/30 hover:border-primary/50 hover:bg-card/70 shadow-[0_0_12px_hsl(var(--primary)/0.25)]",
        ...
        glass: "bg-white/10 backdrop-blur-sm border border-white/50 text-foreground hover:bg-card/70 hover:border-primary/30",
        ...
        "interstellar-secondary": "bg-white/60 backdrop-blur-md text-slate-800 border border-white/60 hover:bg-white/10 hover:border-blue-300 shadow-[0_4px_12px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.04),0_0_20px_rgba(59,130,246,0.1)] transition-all duration-300",
      },
      size: {
