...
## Проблема:
Edge Function возвращает 400 (non-2xx), потому что **старый код ещё работает**.

## Решение (2 минуты):

### 1. Открой Supabase Dashboard:
https://supabase.com/dashboard/project/pyscczcuersdjvpmkiec/functions/fetch-facebook-profiles

### 2. Нажми "Edit"

### 3. УДАЛИ ВСЁ и вставь это:
...
### 5. Обнови страницу integrations

**ГОТОВО!** Ошибка "non-2xx" исчезнет.
